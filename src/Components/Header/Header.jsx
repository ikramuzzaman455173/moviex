...
//           <li className="menuItem"><HiOutlineSearch className="cursor-pointer" onClick={openSearch} /></li>
//         </ul>
//         <div className="mobileMenuItems">
//           <HiOutlineSearch className="cursor-pointer" onClick={openSearch} />
//           {mobileMenu ? <VscChromeClose onClick={() => setMobileMenu(false)} className="cursor-pointer" /> : <SlMenu className="cursor-pointer" onClick={openMobileMenu} />}
//         </div>
//       </ContentWrapper>
